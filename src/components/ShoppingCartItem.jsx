...
function ShoppingCartItem( { product } ) {
    ...
    const [state, dispatch] = useReducer(reducer, { age: product.quantity });
    ...
    return (
      <>
        <li>{product.product.product.name} x {state.age} st</li>
        ...
        {/* <button onClick={() => dispatch({ type: 'delete_all' })}>Hejdå alla</button> */}
